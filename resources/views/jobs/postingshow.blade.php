...
<body>
    ...
    <header id="header" class="my-4">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="dropdown">
                    @if (Auth::user()->profile_picture)
                        <img id="profileImage" src="{{ asset('storage/' . Auth::user()->profile_picture) }}"
                            class="navbar-profile-img dropdown-toggle" id="profileDropdown" data-toggle="dropdown"
            ...
            <!-- Search Bar -->
            <form action="{{ route('posting.ss') }}" method="GET" class="mr-3 ">
            ...
            <!-- Create Post Button -->
            <a href="{{ route('posting.create') }}" class="btn btn-primary ml-3">Create Post</a>
        </nav>
    </header>
                            ...
                            <div class="user-info d-flex align-items-center mb-3">
                                ...
                                <div class="dropdown dropdown-end">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li><a class="dropdown-item"
                                                href="{{ route('posting.edit', $job->id) }}">Edit</a></li>
                                        <li>
